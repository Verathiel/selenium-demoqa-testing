...
class TextBoxPage:
    ...
    def fill_form(self, name, email, current_address, permanent_address):
        ...
        self.driver.find_element(*self.current_address_textarea).send_keys(current_address)
        self.driver.find_element(*self.permanent_address_textarea).send_keys(permanent_address)
